...
import { TargetSystemMapper } from "../src/conditional-compiler/target-mapper";
...
describe("Pommel Predicate Patterns", () => {
  ...
  describe("Predicate Grouping and Context Mapping", () => {
    ...
    it("should map ground context to pommel:is_ground predicate", () => {
      ...
      const overrides = pommelTarget!.content.overrides;
      const hasGroundPredicate = overrides.some((o: any) => 
        o.predicate && o.predicate["pommel:is_ground"] === 1
      );
    ...
    it("should map main hand contexts to pommel:is_held predicates", () => {
      ...
      const overrides = pommelTarget!.content.overrides;
      const heldPredicates = overrides.filter((o: any) => 
        o.predicate && o.predicate["pommel:is_held"] === 1
      );
    ...
    it("should map offhand contexts to pommel:is_offhand predicates", () => {
      ...
      const overrides = pommelTarget!.content.overrides;
      const offhandPredicates = overrides.filter((o: any) => 
        o.predicate && o.predicate["pommel:is_offhand"] === 1
      );
  ...
  describe("Override Deduplication", () => {
    ...
    it("should maintain separate overrides for different models", () => {
      ...
      const hasOpenModel = overrides.some((o: any) => 
        o.model === "minecraft:item/books_3d/book_3d_open"
      );
      const hasClosedModel = overrides.some((o: any) => 
        o.model === "minecraft:item/books_3d/book_3d"
      );
